...
<div id="top_bar" class="<?php echo esc_attr($topbar_type); ?>">
 ...
 ?>
    ...
    <?php }if(rd_check_woo_status() == true && $rd_data['rd_header_cart'] !== 'yes' && $rd_data['rd_topbar_cart'] == 'yes' ){ global $woocommerce; wp_enqueue_script( 'wc-cart-fragments' );?>
    <ul class="header_current_cart">
      <li><a class="cart-content-tb <?php echo esc_attr($rd_data['rd_topbar_cart_type']); if($rd_data['rd_topbar_cart_text'] == 'no'){ echo ' t_none'; } ?>" href="<?php echo esc_url(wc_get_cart_url()); ?>"> <?php echo __('My Cart','thefoxwp'); ?></a>
  ...
  <div class="header_bottom_nav header_shadow <?php if($rd_data['rd_header_sticky'] !== 'no'){ echo ' sticky_header '; } echo esc_attr($nav_type); ?> clearfix" >
    <div class="wrapper tf_o_visible">
      ...
      <ul class="header_current_cart">
        ...
        <li><a class="cart-content" href="<?php echo esc_url(wc_get_cart_url()); ?>"> </a>
          <div class="cart-notification"><span class="item-name"></span>&nbsp;<?php echo __(' was successfully added to your cart.', 'thefoxwp'); ?></div>
          <ul class="header_cart_dropdown cdp_2">
            <div class="widget_shopping_cart_content"></div>
          </ul>
      ...
      <?php } }?>
      <?php if(rd_check_woo_status() == true && $rd_data['rd_header_cart'] == 'yes' && $nav_type !=='nav_type_15' && $nav_type !=='nav_type_16' && $nav_type !=='nav_type_17' && $nav_type !=='nav_type_18'&& $nav_type !=='nav_type_19' && $nav_type !=='nav_type_19_f'){ global $woocommerce; wp_enqueue_script( 'wc-cart-fragments' );?>
      <ul class="header_current_cart">
        <div class="current_item_number"><?php echo sprintf(_n('%d', '%d', $woocommerce->cart->cart_contents_count, 'woothemes'), $woocommerce->cart->cart_contents_count);?></div>
        <li><a class="cart-content" href="<?php echo esc_url(wc_get_cart_url()); ?>"> </a>
          <div class="cart-notification"><span class="item-name"></span>&nbsp;<?php echo __(' was successfully added to your cart.', 'thefoxwp'); ?></div>
