...
if (!function_exists('staff_post_sc')) {
...
if($blog_navigation == 'loadmore_nav'){ ?>
   ...
   /*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!CONFIG!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
				...
				var order = "<?php echo esc_js($staff_order); ?>";
				var orderby = "<?php echo esc_js($staff_orderby); ?>";
   ...
   /*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!CONFIG!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
                ...
                function get_staff_posts (this_obj) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        url: mixajaxurl,
                        data: "html_template="+html_template+"&now_open_works="+now_open_works+"&action=get_staff_posts"+"&works_per_load="+works_per_load+"&order="+order+"&orderby="+orderby+"&column="+column+"&l_target="+l_target+"&first_load="+first_load+"&group=<?php echo esc_js($group); ?>",
...
$cl = get_post_meta($post->ID, 'rd_custom_link', true);

if( $cl !== '' ){
$staff_link = $cl;
}
else{
$staff_link = get_permalink();
}
...
<div data-category="<?php echo esc_attr($echoallterm); ?>" class="staff_post rd_staff_p01 ajax_post <?php echo esc_attr($echoallterm); ?>">
    ...
    <div class="bw-wrapper">       <a href="<?php echo $staff_link ?>" target="<?php echo esc_attr($l_target); ?>"><?php echo the_post_thumbnail( 'staff_tn', array('title' => ""));  ?>
  </a>
  ...
  <div class="member-info">
    ...
    <h3><a href="<?php echo $staff_link ?>" target="<?php echo esc_attr($l_target); ?>"><?php echo the_title() ?></a></h3>
...
<div data-category="<?php echo esc_attr($echoallterm); ?>" class="staff_post rd_staff_p05 ajax_post <?php echo esc_attr($echoallterm); ?>">
  ...
  <div class="member-info">
    ...
    <span class="position" ><?php echo !empty( $position ) ? $position : ''; ?></span>
    <div class="member_desc"><?php $small_desc = substr($desc,0,120); $small_desc .= '...';  echo !empty( $small_desc ) ? $small_desc : ''; ?><a href="<?php echo $staff_link ?>" target="<?php echo esc_attr($l_target); ?>" class="staff_button"><?php echo __('Read More', 'thefoxwp'); ?></a></div>
  </div>
...
<div data-category="<?php echo esc_attr($echoallterm); ?>" class="staff_post rd_staff_p07 ajax_post <?php echo esc_attr($echoallterm); ?>">
	<div class="staff_post_ctn">
		<div class="member-photo s_effect">
			<div class="bw-wrapper"><a href="<?php echo $staff_link ?>" target="<?php echo esc_attr($l_target); ?>"><?php echo the_post_thumbnail( 'staff_tn', array('title' => ""));  ?></a>
            </div>
...
<div class="carousel_recent_post team-member staff_post ajax_post <?php echo esc_attr($echoallterm); ?>">
    ...
    <div class="bw-wrapper">       <a href="<?php echo $staff_link ?>" target="<?php echo esc_attr($l_target); ?>"><?php if($type == 'rstaff_02'){  echo the_post_thumbnail( array(586, 440), array('title' => "")); }else{ echo the_post_thumbnail( 'staff_tn', array('title' => "")); } ?>
...
<?php }
	unset($echoallterm, $pf); endwhile;  wp_reset_postdata();}
