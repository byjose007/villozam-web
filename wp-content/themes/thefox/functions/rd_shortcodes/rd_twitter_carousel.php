...
function twitter_sc($atts, $content = null) {
    ...
    extract(shortcode_atts(array(
		...
		'access_token_secret' => 'MMyXYaF30IxfaMRHg8SWGSGgAi1WOoP3JhkbkJFs1hqBR',

		'access_token' => '437231625-1zz7A9C2zdLzJGyoRoCgGNIDnrMLMtXBrhIce8ED',

		'consumer_secret' => '5ciLTFmqKQsOeiehExsaY1LSdf2j9QLfYZ6qiWwxJ6KMDo36Ib',

		'consumer_key' => 'kWRvkAqRmdaaVOMYFXmYo051p',
...
echo !empty( $t_style ) ? $t_style : '';
	...
	jQuery(document).ready(function($) {
		...
		$("#rd_<?php echo esc_js($rd_twitter); ?> ul").carouFredSel({
					responsive: true,
					width: "100%",
					<?php if($scroll !== 'yes' ){ ?>
					scroll: 1,
