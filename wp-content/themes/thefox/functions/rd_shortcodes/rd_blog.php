...
if( $post_format == 'quote' ){
 ...
 ?>
  <div class="post_ctn">
    ...
    <!-- .entry -->
    <div class="entry">
      <?php 	if ( $post_format == 'audio' ){ echo !empty( $content ) ? $content : '';}
      elseif
      ($more_option == 'cutted'){ rd_custom_excerpt('rd_port_long_excerpt','rd_related_more'); }else{ the_content(__('Read more', 'thefoxwp'));}?>
    </div>
    <!-- .entry END -->
     </div>
	</div>
...
if( $post_format == 'quote' ){
 ...
 ?>
  <div class="post_ctn">
    ...
    <div class="post-info"><span class="pi_date"><?php the_time('j F, Y') ?>    <span class="pi_sep">/</span>    </span><span class="pi_cat"><?php the_category(', '); ?>    <span class="pi_sep">/</span>    </span><span class="pi_comment"><?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?></span></div>
    ...
    <!-- .entry -->
    <div class="entry">
<?php  if($more_option == 'cutted'){ rd_custom_excerpt('rd_port_long_excerpt','rd_trend_more'); }else{ the_content(__('Read more', 'thefoxwp'));}?>
    </div>
    <!-- .entry END -->
...
if(get_post_meta($post->ID, 'rd_show_slider', true) == 'yes') {
 ...
 ?>
  <div class="post_ctn">
    ...
    <div class="post-info"><span class="pi_author"><?php echo __('By','thefoxwp') ?> <?php the_author_posts_link(); ?>    <span class="pi_sep">|</span>    </span><span class="pi_cat"><?php the_category(', '); ?>    <span class="pi_sep">|</span>    </span><span class="pi_comment"><?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?>    <span class="pi_sep">|</span>    </span><span class="pi_like"><?php if( function_exists('zilla_likes') ){ echo do_shortcode('[zilla_likes]');	}?></span></div>
 ...
 ?>
  <div class="post_ctn">
    ...
    <div class="post-title">
     ...
     <!-- .title END-->
     <!-- post-info-top -->
    <div class="post-info"><span class="pi_author"><?php echo __('By','thefoxwp') ?> <?php the_author_posts_link(); ?>    <span class="pi_sep">|</span>    </span><span class="pi_comment"><?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?></span></div>

    <!-- post-info END-->
    <!-- .entry -->
    <div class="entry">
<?php   echo tt_text_truncate(tt_content(), "200");
		 echo '<br><a href="'.get_permalink().'" class="more">'.__('Read more','thefoxwp').'</a>';
 ?>
    </div>
    <!-- .entry END -->
     </div>
 ...
 ?>
  <div class="post_ctn">
    ...
    <div class="post-title">
     ...
     <!-- .title END-->
     <!-- post-info-top -->
    <div class="post-info"><span class="pi_cat"><?php the_category(', '); ?>    <span class="pi_sep">|</span>    </span><span class="pi_comment"><?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?>    <span class="pi_sep">|</span>    </span><span class="pi_like"><?php if( function_exists('zilla_likes') ){ echo do_shortcode('[zilla_likes]');	}?></span></div>
 ...
 ?>
  <div class="post_ctn">
    ...
    <!-- .entry -->
     <div class="entry">
          <?php 	if ( $post_format == 'audio' ){ echo !empty( $content ) ? $content : '';}
          elseif($more_option == 'cutted'){ rd_custom_excerpt('rd_port_long_excerpt','rd_port_more'); }else{ the_content(__('Read more', 'thefoxwp'));}?>
    </div>
	<?php } ?>
    <!-- .entry END -->
    <div class="post-info"><span class="pi_readmore"><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php echo __('Read More','thefoxwp'); ?></a>    <span class="pi_sep">|</span>    </span><span class="pi_comment"><?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?>    <span class="pi_sep">|</span>    </span><span class="pi_like"><?php if( function_exists('zilla_likes') ){ echo do_shortcode('[zilla_likes]');	}?></span></div>
...
<!-- .title END-->
<!-- post-info-top -->
<div class="post-info"><span class="pi_author"><?php echo __('By','thefoxwp') ?> <?php the_author_posts_link(); ?>    <span class="pi_sep">|</span>    </span><span class="pi_date"><?php the_time('j F, Y') ?></span></div>
<!-- post-info END-->
<!-- .entry -->
<div class="entry">
      <?php 	if ( $post_format == 'audio' ){ echo !empty( $content ) ? $content : '';}
      elseif($more_option == 'cutted'){ rd_custom_excerpt('rd_port_long_excerpt','rd_related_more'); }else{ the_content(__('Read more', 'thefoxwp'));}?>
</div> <?php } ?>
<div class="post-bottom-info"><span class="info_comment"><?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?>    <span class="pi_sep">|</span>    </span><span class="info_like"><?php if( function_exists('zilla_likes') ){ echo do_shortcode('[zilla_likes]');	} ?></span></div>
</div>
</div>
<!-- .post-content END-->
<!-- .post END -->
