...
function rd_add_cart_button()
{
	...
	{
		$output = '<a class="add_to_cart_button button product_type_variable" href="'.get_permalink($product->get_id()).'"> '.__("Select options","thefoxwp").'</a>';
	}

	if(in_array($product->get_type(), array('subscription', 'simple', 'bundle')))
	{
		$output .= '<a class="button show_details_button" href="'.get_permalink($product->get_id()).'">  '.__("Show Details","thefoxwp").'</a>';
	}
...
add_filter('woocommerce_add_to_cart_fragments', 'rd_woocommerce_header_add_to_cart_fragment');
...
function rd_woocommerce_header_add_to_cart_fragment( $fragments ) {
	...
	?>
<a class="cart-content" href="<?php echo esc_url(wc_get_cart_url()); ?>" ></a>
  <?php
...
add_filter('woocommerce_add_to_cart_fragments', 'rd_woocommerce_header_dropdown_cart_fragment');
...
if(!function_exists('rd_woocommerce_frontend_search_params'))
{
	...
	function rd_woocommerce_frontend_search_params()
	{
		...
		$product_order['price'] 	= __("Price: low to high",'thefoxwp');
		$product_order['price-desc'] 	= __("Price: high to low",'thefoxwp');
		...
		$output .= "    	<ul>";
		$output .= "    	<li".rd_woo_active_class($po_key, 'default')."><a href='".rd_woo_build_query_string($params, 'orderby', 'default')."'>	".$product_order['default']."</a></li>";
		$output .= "    	<li".rd_woo_active_class($po_key, 'title')."><a href='".rd_woo_build_query_string($params, 'orderby', 'title')."'>	".$product_order['title']."</a></li>";
		$output .= "    	<li".rd_woo_active_class($po_key, 'price')."><a href='".rd_woo_build_query_string($params, 'orderby', 'price')."'>	".$product_order['price']."</a></li>";
		$output .= "    	<li".rd_woo_active_class($po_key, 'price-desc')."><a href='".rd_woo_build_query_string($params, 'orderby', 'price-desc')."'>	".$product_order['price-desc']."</a></li>";
		$output .= "    	<li".rd_woo_active_class($po_key, 'date')."><a href='".rd_woo_build_query_string($params, 'orderby', 'date')."'>	".$product_order['date']."</a></li>";
		$output .= "    	<li".rd_woo_active_class($po_key, 'popularity')."><a href='".rd_woo_build_query_string($params, 'orderby', 'popularity')."'>	".$product_order['popularity']."</a></li>";
		$output .= "    	<li".rd_woo_active_class($po_key, 'popularity')."><a href='".rd_woo_build_query_string($params, 'orderby', 'popularity')."'>	".$product_order['popularity']."</a></li>";
		$output .= "    	</ul>";
		$output .= "    	</li>";
		$output .= "    </ul>";
...
{
	function rd_woo_build_query_string($params, $overwrite_key, $overwrite_value)
	{
