...
//set variable
	...
	$output .= '#mobile-menu{background:'.$mb_bg.'}#mobile-menu ul ul,#mobile-menu #rd_wpml #lang_sel ul ul{background:'.$mb_sm.';}#mobile-menu ul ul ul{background:'.$mb_s_sm.';}';
	...
	$output .= '#mobile-menu ul li a,#mobile-menu #rd_wpml #lang_sel a{color:'.$mb_text.'}#mobile-menu .menu-item-has-children:after{color:'.$mb_icon.';}#mobile-menu ul li li li a{color:'.$mb_s_sm_text.'}#mobile-menu ul ul .menu-item-has-children:after{color:'.$mb_sm_icon.';}';
...
//set variables
	...
	if(isset($rd_data['rd_transparent_header_menu_color']['rgba'])){
	$transparent_nav_text = $rd_data['rd_transparent_header_menu_color']['rgba'];
	}else{

	$transparent_nav_text = 'rgba(255,255,255,0.85)';
	}
	...
	$full_width_menu = $rd_data['rd_header_width'];

	if($full_width_menu == 'yes') {
...
// Header default setting
	...
	$output .='.transparent_header nav > ul > li > a, .transparent_header .cart-content, .transparent_header nav > li.current-menu-item li a, .transparent_header #searchtop_img .fa-search, .transparent_header .header_si a, .transparent_header #nav_button:before {
	color:'.$transparent_nav_text.'!important;
	}';
...
// Nav_type_19 / 20 setting
	...
	$output .='.transparent_header.opaque_header nav > ul > li > a:hover,.transparent_header nav > ul > .current-menu-item > a,.transparent_header.opaque_header nav > ul > .current-menu-item > a,.transparent_header nav > ul > li > a:hover{color:'.$nav_current_text.' !important;}';
...
//Set variables
	...
	$mc_custom_title_font = $rd_data['rd_custom_title_font'];

	$title_font_family = $rd_data['rd_title_font']['font-family'];
	$title_font_size =  $rd_data['rd_title_font']['font-size'];
	$title_font_weight =  $rd_data['rd_title_font']['font-weight'];
	$title_font_line_height =  $rd_data['rd_title_font']['line-height'];


	if($mc_custom_font == 1 ){

	$output .= 'body{font-family:'.$mc_font_family.'; font-size:'.$mc_font_size.'; font-weight:'.$mc_font_weight.'; line-height:'.$mc_font_line_height.'; }p{  line-height:'.$mc_font_line_height.'; }';
...
//Set variables
	...
	if($mc_custom_title_font == 1 ){

	$output .= '.page_title_ctn h1{font-family:'.$title_font_family.' !important; font-size:'.$title_font_size.' !important; font-weight:'.$title_font_weight.' !important; }';
...
/*-----------------------------------------------------------------------------------*/
	...
	$output .= '.woocommerce-page input[type=submit],.woocommerce-page button[type=submit],.customer_details_next,.rd_create_acc,#place_order,.rd_coupon_form .alt2,.coupon input.button.alt2,#review_form  input[type=submit],.woocommerce .addresses .title .edit, .woocommerce-page .addresses .title .edit {background:'.$mc_hl_color.'; color:'.$mc_bg_color.';}';
	$output .= '.cart_details_back,.customer_details_back,#rd_login_form input[type=submit],#rd_login_form button[type=submit],.rd_guest_acc,.update_cart input.checkout-button.button,.cart-collaterals .shipping_calculator .button,.create_acc_done,.wc-backward{background:'.$mc_text_color.'; color:'.$mc_bg_color.';}';
	...
	$output .= '.woocommerce-page input[type=submit]:hover,.woocommerce-page button[type=submit]:hover,.customer_details_next:hover,.rd_create_acc:hover,#place_order:hover,.rd_coupon_form .alt2:hover,.coupon input.button.alt2:hover,#review_form input[type=submit]:hover,.woocommerce .addresses .title .edit:hover, .woocommerce-page .addresses .title .edit:hover{background:'.$mc_hover_color.'; color:'.$mc_bg_color.';}';
	$output .= '.cart_details_back:hover,.customer_details_back:hover,.rd_guest_acc:hover,#rd_login_form input[type=submit]:hover,#rd_login_form button[type=submit]:hover,.update_cart input.checkout-button.button:hover,.cart-collaterals .shipping_calculator .button:hover,.wc-backward:hover{background:'.$mc_light_hover_color.'; color:'.$mc_bg_color.';}';


	//My account page

	$output .= '.my_account_orders{border:1px solid '.$mc_border_color.';}nav.woocommerce-MyAccount-navigation ul li a{color:'.$mc_text_color.'}';
	$output .= 'a.woocommerce-MyAccount-downloads-file.button.alt { background'.$mc_hl_color.';}';
	...
	$output .= '.product_list_widget a,#sidebar .widget_shopping_cart a.button{color:'.$mc_heading_color.'}';
	...
	$output .= '#header_container .cart-notification,#sidebar .widget_shopping_cart .rd_clear_btn{color:'.$mc_text_color.'; }';
...
//Set variables
	...
	$output .= '#preloader_3:before{background:'.$lb_fc.'}#preloader_3:after{background:'.$lb_sc.'}@-webkit-keyframes preloader_3_before { 0% {transform: translateX(0px) rotate(0deg)}  50% {transform: translateX(50px) scale(1.2) rotate(260deg); background:'.$lb_sc.';border-radius:0px;}  100% {transform: translateX(0px) rotate(0deg)}} @keyframes preloader_3_before {  0% {transform: translateX(0px) rotate(0deg)}   50% {transform: translateX(50px) scale(1.2) rotate(260deg); background:'.$lb_sc.';border-radius:0px;}      100% {transform: translateX(0px) rotate(0deg)}} @-webkit-keyframes preloader_3_after {  0% {transform: translateX(0px)}   50% {transform: translateX(-50px) scale(1.2) rotate(-260deg); background:'.$lb_fc.'; border-radius:0px;}    100% {transform: translateX(0px)}} @keyframes preloader_3_after {    0% {transform: translateX(0px)}    50% {transform: translateX(-50px) scale(1.2) rotate(-260deg);background:'.$lb_fc.';border-radius:0px;}   100% {transform: translateX(0px)}}';
...
function tt_display_admin_notice() {
  ...
  ?>
  <div class="notice notice-success is-dismissible cesis_notice"><p>To be able to <strong>Install the Plugins and Import the Demo</strong> you need to <strong><a href='/wp-admin/admin.php?page=TheFox_options&tab=24' target='_blank'>Activate the theme</a></strong></p></div>
  <?php
}
