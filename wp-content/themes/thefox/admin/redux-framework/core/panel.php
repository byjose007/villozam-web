    ...
    if ( ! class_exists( 'reduxCorePanel' ) ) {
        ...
        class reduxCorePanel {
            ...
            private function panel_template() {
                ...
                thefox_db_menu('wpbs_DB-options-active');
                echo '<div class="wrap wpbs_DB-options-notice-wrap"><h2 class="wpbs_DB-options-notice-heading"></h2></div>'; // Stupid hack for Wordpress alerts and warnings

                echo '<div class="clear"></div>';

                echo '<div class="wrap wpbs_DB-options-wrap wpbs-wrap">';
