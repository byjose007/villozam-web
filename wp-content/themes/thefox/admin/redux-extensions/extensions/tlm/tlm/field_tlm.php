...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework_tlm' ) ) {
        ...
        class ReduxFramework_tlm extends ReduxFramework {
            ...
            function __construct( array $field, $value, $parent ) {
            ...
            public function render() {
                ...
                ?>
                    ...
                    <p>If you have problem with the theme activation please check this <a href="https://tranmautritam.ticksy.com/article/14207/" target="_blank">article</a>.</p>
