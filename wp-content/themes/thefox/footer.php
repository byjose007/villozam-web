...
<div id="nav_button_alt"></div>
 ...
 <?php if(rd_check_woo_status() == true && $rd_data['rd_header_cart'] == 'yes' ){ global $woocommerce; wp_enqueue_script( 'wc-cart-fragments' );?>

<ul class="header_current_cart">
<div class="current_item_number"><?php echo sprintf(_n('%d item', '%d items', $woocommerce->cart->cart_contents_count, 'woothemes'), $woocommerce->cart->cart_contents_count);?></div><li><a class="cart-content" href="<?php echo esc_url(wc_get_cart_url()); ?>">
</a>
