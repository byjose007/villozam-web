...
$disable_element = $tt_parallax_speed = $type = '';
...
if ( ! empty( $parallax ) ) {
	...
	if($parallax == 'tt_parallax'){
		$css_classes[] = 'tt_row_has_parallax';
		$wrapper_attributes[] = ' data-parallax_speed="' . esc_attr( $tt_parallax_speed ) . '" '; // parallax speed
	}else{
...
if ($video_background == true){
$output .= '<video playsinline class="parallax_video" preload="auto" autoplay="true" loop="loop" muted="muted" data-top-default="0">';
