 ...
 */
namespace FuseWPVendor\Carbon\Traits;

use FuseWPVendor\Carbon\CarbonInterface;
use FuseWPVendor\Carbon\Exceptions\InvalidTypeException;
use FuseWPVendor\Carbon\Exceptions\NotLocaleAwareException;
use FuseWPVendor\Carbon\Language;
use FuseWPVendor\Carbon\Translator;
use FuseWPVendor\Carbon\TranslatorStrongTypeInterface;
use Closure;
use FuseWPVendor\Symfony\Component\Translation\TranslatorBagInterface;
use FuseWPVendor\Symfony\Component\Translation\TranslatorInterface;
use FuseWPVendor\Symfony\Contracts\Translation\LocaleAwareInterface;
use FuseWPVendor\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (interface_exists('FuseWPVendor\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('FuseWPVendor\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('FuseWPVendor\Symfony\Contracts\Translation\TranslatorInterface', 'FuseWPVendor\Symfony\Component\Translation\TranslatorInterface');
}
